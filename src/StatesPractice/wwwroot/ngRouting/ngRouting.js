...
(function (NGRouting) {
    ...
    var QuoteService = (function () {
        ...
        QuoteService.prototype.randomQuote = function (arr) {
    ...
    var QuoteController = (function () {
        function QuoteController(quoteService) {
        ...
        QuoteController.prototype.newFortune = function () {
            this.fortune = this.quoteService.randomQuote(this.quoteService.fortunes);
        };
        QuoteController.prototype.newQuote = function () {
...
//# sourceMappingURL=ngRouting.js.map